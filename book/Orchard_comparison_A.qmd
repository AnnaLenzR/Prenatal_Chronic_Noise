...
pacman::p_load(
  DT, dtplyr, here, knitr, tidyverse, patchwork, metafor
)

if (!requireNamespace("orchaRd", quietly = TRUE)) {
  stop("Package 'orchaRd' is not installed. Install once with remotes::install_github('daniel1noble/orchaRd', upgrade = 'never').")
}
